			...
			<div>
				<table>
					...
					<tr>
						...
						<td class="text_right">{{$data['roster']->quantities->sum('quantity')}}</td>
					</tr>
				</table>
			</div>
		</div>
		...
		<div class="mt-20">
			...
			<table>
				...
				@forelse($data['roster']->teams as $team)
					<tr>
						<td class="text_left">{{$loop->iteration}}.</td>
						<td class="text_center">{{ $team->size }}</td>
						<td class="text_center"> {{ $team->number }}</td>
						<td class="text_center">{{ $team->name }}</td>
						<td class="text_center">{{ $team->note }}</td>
						<td class="text_center">{{ $team->shortsize }}</td>
					</tr>
				@empty
				@endforelse
				</tbody>
